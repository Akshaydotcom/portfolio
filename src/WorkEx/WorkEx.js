...
export const WorkEx=()=>{
    ...
    let jd2="Led and managed a team of 3 QA testers to conduct comprehensive manual UI and functional testing for 15 different applications, ensuring high-quality deliverables and a 30% reduction in post-release defects. Mentored new joiners to understand their projects and team processes. Collaborated with Onshore and Offshore Client Teams to carry out project hand-offs. Designed and improved front-end UI of the Clients' web-app using HTML, CSS, JavaScript, and LESS Preprocessor, leading to a 20% increase in user engagement and a 25% decrease in bounce rate.";
